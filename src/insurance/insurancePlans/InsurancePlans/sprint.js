...
import PlanCard from 'insurance/insurancePlans/PlanCard/sprint';
    ...
    return (
      <div className={styles.layout}>
        <div className={styles.card}>
          <PlanCard sprintSubId={subId} sku={sku} insurancePlan={insurancePlans[1]}/>
        </div>
        <div className={styles.middlecard}>
          <PlanCard sprintSubId={subId} sku={sku} insurancePlan={insurancePlans[0]}/>
        </div>
        <div className={styles.card}>
          <PlanCard sprintSubId={subId} sku={sku} insurancePlan={insurancePlans[2]}/>
        </div>
      </div>
    )
  }
